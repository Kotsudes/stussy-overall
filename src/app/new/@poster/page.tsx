...
export default function Poster() {
    const { setTitle, setCanvasSize }: { setTitle: React.Dispatch<React.SetStateAction<string>>, setCanvasSize: React.Dispatch<React.SetStateAction<{ width: number; height: number }>> } = useAppContext()
