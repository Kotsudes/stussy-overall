        ...
        <Navbar maxWidth="full" height={"36px"}>
            <NavbarContent justify="start">
                <Dropdown>
                    ...
                    >
                        <DropdownItem key="save" aria-label="save" startContent={icons.user} onPress={saveCanvas}>
                            Enregistrer
                        </DropdownItem>
                        <DropdownItem key="save_as" aria-label="save as" startContent={icons.user}>
                            Enregistrer sous
                        </DropdownItem>
                        <DropdownItem key="export" aria-label="export" startContent={icons.user} onPress={() => {
                            toPng(canvas.current as HTMLCanvasElement, { cacheBust: true })
                                .then((dataUrl) => {
